...
axios.put(str,{VC:vc,DegreEnfencement:deg,Temperature:temp,TAV:tav,Densite:dens,Coef:coef})
.then(res => {
    if(res.status===200){
     reset({VC:null,DegreEnfencement:null,Temperature:null,TAV:null,Densite:null,Coef:null})
      setSubmitted(true)
